...
public class LoginActivity extends BaseActivity implements View.OnClickListener, View.OnFocusChangeListener
{
	...
	{
		TranslateAnimation mHiddenAction = new TranslateAnimation(Animation.RELATIVE_TO_SELF, a, Animation.RELATIVE_TO_SELF,
				b, Animation.RELATIVE_TO_SELF, c, Animation.RELATIVE_TO_SELF, d);
